...
class Modelos_2():
  ...
  def extraer_ano(self,df):
    ...
    print("flag fecha")
    df['FECHACONSTITUCION'] = pd.to_datetime(df['FECHACONSTITUCION'],errors='coerce')#, format='%d/%m/%Y'
  ...
  def Logs(self):
    ...
    if num_reg_con_vacios>0:
      ...
      for campo, conteo, indices in zip(df_conteo_reg_vacios['Nombre campo'],df_conteo_reg_vacios['Registros vacíos'],df_conteo_reg_vacios['Índices de los registros vacíos']):
        ...
        mask_logs = ['CLIENTES_CON_PRODUCTO','FRECUENCIA_DE_CONTACTO','NIVEL_EDUCATIVO','SITUACION_LABORAL','FECHA_NACIMIENTO','CIUDAD','DEPARTAMENTO']
